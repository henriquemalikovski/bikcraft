...
<head>
  ...
  <title>Bickcraft - Conheça a nossa história</title>
  ...
  <section data-anime="800" class="fadeInDown missao-sobre container">
    <div class="grid-10">
      <h2 class="subtitulo-interno">
        História, Missão e Vissão
      </h2>
      <p>
        Ao contrário da crença popular, o Lorem Ipsum não é simplesmente texto aleatório. Tem raízes numa peça de literatura clássica em Latim, de 45 AC, tornando-o com mais de 2000 anos. Richard McClintock, um professor de Latim no Colégio
      </p>
      <p>
        Hampden-Sydney, na Virgínia, procurou uma das palavras em Latim mais obscuras (consectetur) numa passagem Lorem Ipsum, e atravessando as cidavvvdes do mundo na literatura clássica, descobriu a sua origem.
      </p>
    </div>
