...
<body>
  ...
  <section class="introducao-interna interna-contato">
    <div data-anime="400" class="fadeInDown container">
      <h1>Contato</h1>
      <p>Entre em contato com a gente e tire todas as suas dúvidas</p>
    </div>
  </section>

  <section data-anime="800" class="fadeInDown contato container">
    <form method="POST" action="" class="grid-8 contato-form formphp" id="form-orcamento">
    ...
    <div class="contato-dados grid-8">
      ...
      <span>Rua Barão do Triunfo, Americano</span>
      <span>Lajeado/RS</span>
      <h3>Redes Sociais</h3>
      <ul>
